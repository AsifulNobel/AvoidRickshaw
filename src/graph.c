...
/************* text start ********************/
	...
	cairo_set_font_size (ad->cairo, 40.0);
	cairo_set_source_rgb(ad->cairo, 0, 0, 0);
	cairo_move_to (ad->cairo, 0.3 * d, 0.05 * d);
	...
	cairo_set_font_size (ad->cairo, 30.0);
	cairo_set_source_rgb(ad->cairo, 0,0,0);
	cairo_move_to (ad->cairo, 0.1 * d, 0.9 * d);
	cairo_show_text (ad->cairo, "Last Week");
	...
	cairo_move_to (ad->cairo, 0.55 * d, 1.1 * d);
	cairo_show_text (ad->cairo, totalDays);

	cairo_move_to (ad->cairo, 0.6 * d, 1.1 * d);
