...
PID: 28310
Date: 2016-07-26 21:27:08+0600
Executable File Path: /opt/usr/apps/org.example.avoidrickshaw/bin/avoidrickshaw
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 28310, uid 5000)

Register Information
r0   = 0x000001e0, r1   = 0xb82f4088
r2   = 0xb2a4c1c3, r3   = 0xb2a4c1c7
r4   = 0xb6ac752d, r5   = 0xb60426ec
r6   = 0xb602fe30, r7   = 0xb2a4c1c3
r8   = 0xb2a4c1c7, r9   = 0x00000000
r10  = 0xb833d3f0, fp   = 0x00000000
ip   = 0x00000001, sp   = 0xbeb45150
lr   = 0xb6028a17, pc   = 0xb6ac7546
cpsr = 0x600d0030
...
Threads: 5
PID = 28310 TID = 28310
28310 28313 29198 29205 29233 

Maps Information
b03d0000 b0bcf000 rw-p [stack:29233]
b138d000 b1b8c000 rw-p [stack:29205]
b1b8c000 b1b94000 r-xp /usr/lib/libcapi-appfw-package-manager.so.0.0.49
b1ba4000 b1ba6000 r-xp /usr/lib/liblbs-agps.so.0.1.0
b1bb6000 b1bc4000 r-xp /usr/lib/liblbs-dbus.so.0.1.0
b1bdb000 b1bdd000 r-xp /usr/lib/location/module/libwps.so.0.6.8_9
b1bed000 b1bf0000 r-xp /usr/lib/location/module/libgps.so.0.6.8_9
b1d11000 b2510000 rw-p [stack:29198]
b258c000 b2594000 r-xp /usr/lib/ecore_evas/engines/extn/v-1.13/module.so
b25a5000 b25a6000 r-xp /usr/lib/edje/modules/feedback/v-1.13/module.so
b25b6000 b25ca000 r-xp /usr/lib/edje/modules/elm/v-1.13/module.so
b25de000 b25df000 r-xp /usr/lib/libX11-xcb.so.1.0.0
b25ef000 b25f2000 r-xp /usr/lib/libxcb-sync.so.1.0.0
b2603000 b2604000 r-xp /usr/lib/libxshmfence.so.1.0.0
b2614000 b2616000 r-xp /usr/lib/libxcb-present.so.0.0.0
b2626000 b2628000 r-xp /usr/lib/libxcb-dri3.so.0.0.0
b2638000 b2648000 r-xp /usr/lib/evas/modules/engines/software_x11/v-1.13/module.so
b2658000 b2664000 r-xp /usr/lib/ecore_evas/engines/x/v-1.13/module.so
b28b4000 b28b6000 r-xp /usr/lib/libpkgmgr_installer_status_broadcast_server.so.0.1.0
b28c6000 b28cc000 r-xp /usr/lib/libpkgmgr_installer_client.so.0.1.0
b28dc000 b28f0000 r-xp /usr/lib/libpkgmgr-client.so.0.1.68
b2900000 b291a000 r-xp /usr/lib/libprivacy-manager-client.so.0.0.6
b292a000 b2930000 r-xp /usr/lib/libcapi-appfw-app-manager.so.0.2.8
b2940000 b2947000 r-xp /usr/lib/libeventsystem.so.0.0.1
b2957000 b297a000 r-xp /usr/lib/libSLP-location-product.so.0.9.0
b298b000 b29a2000 r-xp /usr/lib/libSLP-location.so.0.11.5_5
b29b2000 b29b9000 r-xp /usr/lib/libefl-extension.so.0.1.0
b29ca000 b29d2000 r-xp /usr/lib/libcapi-system-system-settings.so.0.0.2
b29e2000 b29e6000 r-xp /usr/lib/libcapi-system-sensor.so.0.1.18
b29f7000 b2a06000 r-xp /usr/lib/libcapi-location-manager.so.0.6.1_3
b2a16000 b2a1d000 r-xp /usr/lib/libcapi-appfw-preference.so.0.3.1.0
b2a2f000 b2a35000 r-xp /usr/lib/bufmgr/libtbm_sprd7727.so.0.0.0
b2a45000 b2a4d000 r-xp /opt/usr/apps/org.example.avoidrickshaw/bin/avoidrickshaw
b2b6e000 b2c51000 r-xp /usr/lib/libscim-1.0.so.8.2.3
b2c88000 b2cb0000 r-xp /usr/lib/ecore_imf/modules/isf/v-1.13/module.so
b2cc2000 b34c1000 rw-p [stack:28313]
b34c1000 b34c3000 r-xp /usr/lib/ecore/system/systemd/v-1.13/module.so
b34d3000 b34dd000 r-xp /lib/libnss_files-2.20-2014.11.so
b34ee000 b34f7000 r-xp /lib/libnss_nis-2.20-2014.11.so
b3508000 b3519000 r-xp /lib/libnsl-2.20-2014.11.so
b352c000 b3532000 r-xp /lib/libnss_compat-2.20-2014.11.so
b3543000 b3544000 r-xp /usr/lib/osp/libappinfo.so.1.2.2.1
b356c000 b3573000 r-xp /usr/lib/libminizip.so.1.0.0
b3583000 b3588000 r-xp /usr/lib/libstorage.so.0.1
b3598000 b35ed000 r-xp /usr/lib/libmmfcamcorder.so.0.0.0
b3603000 b3617000 r-xp /usr/lib/libcapi-media-camera.so.0.1.89
b3627000 b366b000 r-xp /usr/lib/libgstbase-1.0.so.0.405.0
b367b000 b3683000 r-xp /usr/lib/libgstapp-1.0.so.0.405.0
b3693000 b36c3000 r-xp /usr/lib/libgstvideo-1.0.so.0.405.0
b36d6000 b378f000 r-xp /usr/lib/libgstreamer-1.0.so.0.405.0
b37a3000 b37f7000 r-xp /usr/lib/libmmfplayer.so.0.0.0
b3808000 b3823000 r-xp /usr/lib/libcapi-media-player.so.0.2.16
b3833000 b38f4000 r-xp /usr/lib/libprotobuf.so.9.0.1
b3907000 b3919000 r-xp /usr/lib/libefl-assist.so.0.1.0
b3929000 b392d000 r-xp /usr/lib/libogg.so.0.7.1
b393d000 b395f000 r-xp /usr/lib/libvorbis.so.0.4.3
b396f000 b3a53000 r-xp /usr/lib/libvorbisenc.so.2.0.6
b3a6f000 b3a7c000 r-xp /usr/lib/libmdm-common.so.1.0.98
b3a8d000 b3ad0000 r-xp /usr/lib/libsndfile.so.1.0.25
b3ae5000 b3b2c000 r-xp /usr/lib/pulseaudio/libpulsecommon-4.0.so
b3b3d000 b3b43000 r-xp /usr/lib/libjson-c.so.2.0.1
b3b54000 b3b5b000 r-xp /usr/lib/libcapi-media-tool.so.0.2.2
b3b6b000 b3bab000 r-xp /usr/lib/libmdm.so.1.2.10
b3bbb000 b3bc3000 r-xp /usr/lib/lib_DNSe_NRSS_ver225.so
b3bd2000 b3be2000 r-xp /usr/lib/lib_SamsungRec_TizenV04014.so
b3c03000 b3c63000 r-xp /usr/lib/libasound.so.2.0.0
b3c75000 b3cab000 r-xp /usr/lib/libpulse.so.0.16.2
b3cbc000 b3cbf000 r-xp /usr/lib/libpulse-simple.so.0.0.4
b3ccf000 b3cd2000 r-xp /usr/lib/libsyspopup_caller.so.0.1.0
b3ce2000 b3ce7000 r-xp /usr/lib/libmmfsoundcommon.so.0.0.0
b3cf7000 b3cf8000 r-xp /usr/lib/libgthread-2.0.so.0.4301.0
b3d08000 b3d13000 r-xp /usr/lib/libaudio-session-mgr.so.0.0.1
b3d27000 b3d2e000 r-xp /usr/lib/libmmutil_imgp.so.0.0.0
b3d3e000 b3d44000 r-xp /usr/lib/libmmutil_jpeg.so.0.0.0
b3d54000 b3d59000 r-xp /usr/lib/libmmfsession.so.0.0.1
b3d69000 b3d84000 r-xp /usr/lib/libmmfsound.so.0.1.0
b3d94000 b3d9b000 r-xp /usr/lib/libmmfcommon.so.0.0.0
b3dab000 b3dae000 r-xp /usr/lib/libcapi-media-image-util.so.0.1.10
b3dbf000 b3ded000 r-xp /usr/lib/libidn.so.11.5.44
b3dfd000 b3e13000 r-xp /usr/lib/libnghttp2.so.5.4.0
b3e24000 b3e2e000 r-xp /usr/lib/libcares.so.2.1.0
b3e3e000 b3e48000 r-xp /usr/lib/libcapi-media-sound-manager.so.0.3.31
b3e58000 b3e5a000 r-xp /usr/lib/libcapi-media-wav-player.so.0.1.19
b3e6a000 b3e6b000 r-xp /usr/lib/libmmfkeysound.so.0.0.0
b3e7b000 b3e7f000 r-xp /usr/lib/libecore_ipc.so.1.13.0
b3e90000 b3eb8000 r-xp /usr/lib/libui-extension.so.0.1.0
b3ec9000 b3ef2000 r-xp /usr/lib/libturbojpeg.so
b3f12000 b3f18000 r-xp /usr/lib/libgif.so.4.1.6
b3f28000 b3f6e000 r-xp /usr/lib/libcurl.so.4.3.0
b3f7f000 b3fa0000 r-xp /usr/lib/libexif.so.12.3.3
b3fbb000 b3fd0000 r-xp /usr/lib/libtts.so
b3fe1000 b3fe9000 r-xp /usr/lib/libfeedback.so.0.1.4
b3ff9000 b40b9000 r-xp /usr/lib/libdali-core.so.0.0.0
b40c4000 b41b7000 r-xp /usr/lib/libdali-adaptor.so.0.0.0
b41d7000 b42b1000 r-xp /usr/lib/libdali-toolkit.so.0.0.0
b42c8000 b42ca000 r-xp /usr/lib/libboost_system.so.1.51.0
b42da000 b42e0000 r-xp /usr/lib/libboost_chrono.so.1.51.0
b42f0000 b4313000 r-xp /usr/lib/libboost_thread.so.1.51.0
b4324000 b4326000 r-xp /usr/lib/libappsvc.so.0.1.0
b4336000 b4338000 r-xp /usr/lib/libcapi-appfw-app-common.so.0.3.1.0
b4349000 b434e000 r-xp /usr/lib/libcapi-appfw-app-control.so.0.3.1.0
b4365000 b4367000 r-xp /usr/lib/libosp-env-config.so.1.2.2.1
b4377000 b437e000 r-xp /usr/lib/libsensord-share.so
b438e000 b43a6000 r-xp /usr/lib/libsensor.so.1.1.0
b43b7000 b43ba000 r-xp /usr/lib/libXv.so.1.0.0
b43ca000 b43cf000 r-xp /usr/lib/libutilX.so.1.1.0
b43df000 b43e4000 r-xp /usr/lib/libappcore-common.so.1.1
b43f4000 b43fb000 r-xp /usr/lib/libcapi-ui-efl-util.so.0.2.14
b440e000 b4412000 r-xp /usr/lib/libcapi-appfw-application.so.0.3.1.0
b4423000 b44ed000 r-xp /usr/lib/libCOREGL.so.4.0
b4504000 b4507000 r-xp /usr/lib/libuuid.so.1.3.0
b4518000 b452f000 r-xp /usr/lib/libblkid.so.1.1.0
b4540000 b4542000 r-xp /usr/lib/libXau.so.6.0.0
b4552000 b4555000 r-xp /usr/lib/libEGL.so.1.4
b455d000 b4563000 r-xp /usr/lib/libxcb-render.so.0.0.0
b4573000 b4575000 r-xp /usr/lib/libxcb-shm.so.0.0.0
b4586000 b4594000 r-xp /usr/lib/libGLESv2.so.2.0
b459d000 b45ff000 r-xp /usr/lib/libpixman-1.so.0.28.2
b4614000 b462c000 r-xp /usr/lib/libmount.so.1.1.0
b463d000 b4651000 r-xp /usr/lib/libxcb.so.1.1.0
b4662000 b4669000 r-xp /lib/libcrypt-2.20-2014.11.so
b46a1000 b46b2000 r-xp /usr/lib/libsharedrule-client.so.1.0.0
b46c3000 b46c5000 r-xp /usr/lib/libiri.so
b46d5000 b46e0000 r-xp /usr/lib/libgpg-error.so.0.15.0
b46f1000 b4706000 r-xp /lib/libexpat.so.1.5.2
b4718000 b47d6000 r-xp /usr/lib/libcairo.so.2.11200.14
b47e9000 b47f1000 r-xp /usr/lib/libdrm.so.2.4.0
b4801000 b4804000 r-xp /usr/lib/libdri2.so.0.0.0
b4815000 b4863000 r-xp /usr/lib/libssl.so.1.0.0
b4878000 b4884000 r-xp /usr/lib/libeeze.so.1.13.0
b4894000 b489d000 r-xp /usr/lib/libethumb.so.1.13.0
b48ad000 b48b0000 r-xp /usr/lib/libecore_input_evas.so.1.13.0
b48c0000 b4a77000 r-xp /usr/lib/libcrypto.so.1.0.0
b56ce000 b56d7000 r-xp /usr/lib/libXi.so.6.1.0
b56e7000 b56e9000 r-xp /usr/lib/libXgesture.so.7.0.0
b56f9000 b56fd000 r-xp /usr/lib/libXtst.so.6.1.0
b570d000 b5713000 r-xp /usr/lib/libXrender.so.1.3.0
b5723000 b5729000 r-xp /usr/lib/libXrandr.so.2.2.0
b573a000 b573c000 r-xp /usr/lib/libXinerama.so.1.0.0
b574c000 b574f000 r-xp /usr/lib/libXfixes.so.3.1.0
b575f000 b576a000 r-xp /usr/lib/libXext.so.6.4.0
b577a000 b577c000 r-xp /usr/lib/libXdamage.so.1.1.0
b578c000 b578e000 r-xp /usr/lib/libXcomposite.so.1.0.0
b579f000 b5881000 r-xp /usr/lib/libX11.so.6.3.0
b5894000 b589b000 r-xp /usr/lib/libXcursor.so.1.0.2
b58ab000 b58c3000 r-xp /usr/lib/libudev.so.1.6.0
b58c5000 b58c8000 r-xp /lib/libattr.so.1.1.0
b58d8000 b58f8000 r-xp /usr/lib/libsecurity-server-commons.so.1.0.0
b58fa000 b58ff000 r-xp /usr/lib/libffi.so.6.0.2
b590f000 b5927000 r-xp /lib/libz.so.1.2.8
b5937000 b5939000 r-xp /usr/lib/libgmodule-2.0.so.0.4301.0
b5949000 b5a1e000 r-xp /usr/lib/libxml2.so.2.9.2
b5a33000 b5ace000 r-xp /usr/lib/libstdc++.so.6.0.20
b5aea000 b5aed000 r-xp /usr/lib/libSLP-db-util.so.0.1.0
b5afd000 b5b16000 r-xp /usr/lib/libpkgmgr_parser.so.0.1.0
b5b27000 b5b38000 r-xp /lib/libresolv-2.20-2014.11.so
b5b4c000 b5bc6000 r-xp /usr/lib/libgcrypt.so.20.0.3
b5bdb000 b5bdd000 r-xp /usr/lib/libecore_imf_evas.so.1.13.0
b5bed000 b5bf4000 r-xp /usr/lib/libembryo.so.1.13.0
b5c04000 b5c1c000 r-xp /usr/lib/libpng12.so.0.50.0
b5c2d000 b5c50000 r-xp /usr/lib/libjpeg.so.8.0.2
b5c71000 b5c85000 r-xp /usr/lib/libector.so.1.13.0
b5c96000 b5cae000 r-xp /usr/lib/liblua-5.1.so
b5cbf000 b5d16000 r-xp /usr/lib/libfreetype.so.6.11.3
b5d2a000 b5d52000 r-xp /usr/lib/libfontconfig.so.1.8.0
b5d63000 b5d76000 r-xp /usr/lib/libfribidi.so.0.3.1
b5d87000 b5dbe000 r-xp /usr/lib/libharfbuzz.so.0.940.0
...
b699c000 b6a1e000 r-xp /usr/lib/libedje.so.1.13.0
...
b6c53000 b6e88000 r-xp /usr/lib/libelementary.so.1.13.0
...
b8122000 b841b000 rw-p [heap]
beb25000 beb46000 rw-p [stack]
b8122000 b841b000 rw-p [heap]
beb25000 beb46000 rw-p [stack]
End of Maps Information

Callstack Information (PID:28310)
Call Stack Count: 1
 0: (0xb6ac7546) [/usr/lib/libevas.so.1] + 0x58546
End of Call Stack
...
07-25 22:05:37.938+0600 D/avoid
